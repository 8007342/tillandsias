...
- 2026-06-20T05:10Z (linux-tlatoani-big-pickle): Implemented containerfile-dnf-migration slice 1 — migrated wasmtime from curl+tar to microdnf install wasmtime. Scope correction: buf already absent from Containerfile, ollama intentionally avoids DNF (GPU bloat). Commit `<pending>`.
