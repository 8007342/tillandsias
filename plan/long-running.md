...
|---:|---|---|---|---|
| 245 | `network-architecture-audit` | research (DRAFT v1 published) | — | opencode-bigpickle (NA-01..06), antigravity-gemini (NA-01,02,03,05), codex-gpt55-highthink (NA-01,03,04,06) |
...
| 251 | `long-running-work-packet-methodology` | verification (implementation complete 2026-07-10) | — | opencode-bigpickle (LM-01..05), antigravity-gemini (LM-01,02,04), codex-gpt55-highthink (LM-03,04,05) |
