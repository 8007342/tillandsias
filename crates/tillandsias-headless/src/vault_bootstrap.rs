...
/// Provision the per-mirror HOST-signer AppRole (order 1310-5e6g, closing the
...
mod tests {
    ...
    /// ORDER 1310-5e6g. The host-signer AppRole must pair one-to-one with its
    ...
    /// ORDER 1310-5e6g. Source-level, because the property is "takes no other
