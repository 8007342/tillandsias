...
<!-- Last regenerated: 2026-05-15 at 16:23 UTC -->

# Progression Trends

_Generated at 2026-05-15T16:23:26Z for series `Local Development` (`local_development`)._

_Source: `target/convergence/centicolon-signature.jsonl` · 24 signature records · latest release `0.1.260513.6` at commit `742594ffbae9`._
...
| Worst reason | `Post-build smoke failures detected (see /tmp/litmus-post-build.log)` |
| CI result | `FAIL` |
