...
<!-- Last regenerated: 2026-07-08 at 21:21 UTC -->

# Progression Trends

_Generated at 2026-07-08T21:21:19Z for series `Local Development` (`local_development`)._

_Source: `target/convergence/centicolon-signature.jsonl` · 99 signature records · latest release `0.3.260707.1` at commit `f1d3dcc78f8c`._
...
| Field | Value |
|---|---|
| Release | `0.3.260707.1` |
| Commit | `f1d3dcc78f8c` |
| Closed | `77.8%` |
| Residual cc | `180` |
| Worst spec | `spec:podman-orchestration` |
| Worst reason | `Check failed: tray-contract` |
| CI result | `FAIL` |
