...
<!-- Last regenerated: 2026-05-16 at 21:15 UTC -->

# Progression Trends

_Generated at 2026-05-16T21:15:26Z for series `Local Development` (`local_development`)._

_Source: `target/convergence/centicolon-signature.jsonl` · 28 signature records · latest release `0.1.260516.8` at commit `ec71ce87c578`._
...
| Field | Value |
|---|---|
| Release | `0.1.260516.8` |
| Commit | `ec71ce87c578` |
| Closed | `0.0%` |
| Residual cc | `140` |
| Worst spec | `spec:litmus-convergence` |
| Worst reason | `Runtime litmus failures detected (see /tmp/litmus-runtime.log)` |
| CI result | `FAIL` |
