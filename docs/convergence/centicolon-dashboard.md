...
<!-- Last regenerated: 2026-06-19 at 22:32 UTC -->

# Progression Trends

_Generated at 2026-06-19T22:32:45Z for series `Local Development` (`local_development`)._

_Source: `target/convergence/centicolon-signature.jsonl` · 258 signature records · latest release `0.3.260619.2` at commit `5b3058c428e9`._
...
| Field | Value |
|---|---|
| Release | `0.3.260619.2` |
| Commit | `5b3058c428e9` |
| Closed | `94.7%` |
| Residual cc | `40` |
| Worst spec | `spec:dev-build` |
| Worst reason | `Rust code not formatted: run 'cargo fmt --all' (see /tmp/fmt-check.log)` |
| CI result | `FAIL` |
| Alert level | `yellow` (red < 90%, yellow < 95%) |
