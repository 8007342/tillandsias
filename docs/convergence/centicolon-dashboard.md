...
<!-- Last regenerated: 2026-06-02 at 16:23 UTC -->

# Progression Trends

_Generated at 2026-06-02T16:23:16Z for series `Local Development` (`local_development`)._

_Source: `target/convergence/centicolon-signature.jsonl` · 124 signature records · latest release `0.2.260602.2` at commit `88ab3a3263e3`._
...
| Field | Value |
|---|---|
| Release | `0.2.260602.2` |
| Commit | `88ab3a3263e3` |
| Closed | `57.3%` |
| Residual cc | `320` |
| Worst spec | `spec:spec-traceability` |
| Worst reason | `Spec-code drift detected: ghost traces or zero-trace specs found (see /tmp/drift-check.log)` |
| CI result | `FAIL` |
