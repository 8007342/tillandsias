...
Re-measured directly on v56.9.21.2, three consecutive runs, plus pirria
independently on a build from 320c66ad3 — rc=1 every time. The row filed against
it (1338-i23k) is closed OBSOLETED: the defect never existed.
