...
|---------------|-------------------------------------|----------------------------------------------------------------|
| forge         | `fedora-minimal:44` container image | `skopeo copy docker://registry.fedoraproject.org/fedora-minimal:44` then layer-flatten |
...
| inference     | `fedora-minimal:44` + ollama        | skopeo (matches Linux/macOS Containerfile) + ollama tarball install |
