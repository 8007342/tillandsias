...
- `cheatsheets/runtime/forge-paths-ephemeral-vs-persistent.md` — the four-category path model and per-language env vars
- `cheatsheets/runtime/forge-shared-cache-via-nix.md` — why nix is the shared-cache entry point
- `cheatsheets/runtime/cheatsheet-architecture-v2.md` — how cheatsheets are organised and queried
- `cheatsheets/agents/openspec.md` — the OpenSpec workflow and artifact lifecycle
