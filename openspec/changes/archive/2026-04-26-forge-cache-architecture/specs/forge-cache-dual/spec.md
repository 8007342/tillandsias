...
- `cheatsheets/runtime/forge-paths-ephemeral-vs-persistent.md` — definitive path categorisation
- `cheatsheets/runtime/forge-shared-cache-via-nix.md` — why nix is the right shared-cache entry point
- `cheatsheets/build/nix-flake-basics.md` — flake authoring (host-side nix store population)
- `cheatsheets/runtime/forge-container.md` (DRAFT) — broader runtime contract
