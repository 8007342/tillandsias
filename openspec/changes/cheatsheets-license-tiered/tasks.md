...
- [ ] 4.4 Author `cheatsheets/build/distro-packaged-cheatsheets.md` (with full provenance) describing how to add a new distro-packaged cheatsheet (pick a doc package, add to forge image manifest, author cheatsheet with `tier: distro-packaged`).
