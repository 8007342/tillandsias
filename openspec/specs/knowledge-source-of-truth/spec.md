...
## Purpose
Defines the knowledge directory structure for project-agnostic technology cheatsheets, their format, indexing, version tracking, and external debug source fetching.
