...
The system MUST attach all Tillandsias-managed containers (proxy, forge, git, inference) to the `tillandsias-enclave` network. Only the proxy container MUST additionally be attached to the default bridge network for external access.
