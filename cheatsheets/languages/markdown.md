...
- **Cache target:** `~/.cache/tillandsias/cheatsheets-pulled/$PROJECT/spec.commonmark.org/0.31.2/`
- **License:** see-license-allowlist
- **License URL:** https://spec.commonmark.org/0.31.2/

### Materialize recipe (agent runs this)

```bash
set -euo pipefail
TARGET="$HOME/.cache/tillandsias/cheatsheets-pulled/$PROJECT/spec.commonmark.org/0.31.2/"
...
2. If the project leans on this tool/topic heavily, generate a project-contextual
   cheatsheet at `<project>/.tillandsias/cheatsheets/languages/markdown.md` using
