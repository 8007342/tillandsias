...
- **Cache target:** `~/.cache/tillandsias/cheatsheets-pulled/$PROJECT/man.openbsd.org/ssh`
- **License:** see-license-allowlist
- **License URL:** https://man.openbsd.org/ssh

### Materialize recipe (agent runs this)

```bash
set -euo pipefail
TARGET="$HOME/.cache/tillandsias/cheatsheets-pulled/$PROJECT/man.openbsd.org/ssh"
...
2. If the project leans on this tool/topic heavily, generate a project-contextual
   cheatsheet at `<project>/.tillandsias/cheatsheets/utils/ssh.md` using
