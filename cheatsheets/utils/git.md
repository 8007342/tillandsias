...
- **Cache target:** `~/.cache/tillandsias/cheatsheets-pulled/$PROJECT/git-scm.com/docs`
- **License:** see-license-allowlist
- **License URL:** https://git-scm.com/docs

### Materialize recipe (agent runs this)

```bash
set -euo pipefail
TARGET="$HOME/.cache/tillandsias/cheatsheets-pulled/$PROJECT/git-scm.com/docs"
...
2. If the project leans on this tool/topic heavily, generate a project-contextual
   cheatsheet at `<project>/.tillandsias/cheatsheets/utils/git.md` using
